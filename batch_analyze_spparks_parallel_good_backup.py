...
ENABLE_VTKHDF_OUTPUT = True # Generate VTK-HDF files (modern high-performance format)
...
if __name__ == "__main__":
    ...
    try:
        result_path = create_method2_rendering(coords, colors, grid_shape, camera_position, title, output_path)
